...
ICAP Test System v1.0.4 - Python-basierter ICAP-Server mit ClamAV-Integration.
...
- Rebranding: ICAP Security Testing Suite
...
- [GitHub Release](https://github.com/roimme65/icap-test-script/releases/tag/v1.0.4)
