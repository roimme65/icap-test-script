...
ICAP Test System v1.0.2 - Python-basierter ICAP-Server mit ClamAV-Integration.
...
- Fix healthcheck for ICAP server
...
- [GitHub Release](https://github.com/roimme65/icap-test-script/releases/tag/v1.0.2)
