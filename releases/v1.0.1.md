...
ICAP Test System v1.0.1 - Python-basierter ICAP-Server mit ClamAV-Integration.

## 🎯 Neue Features

- Initial commit: ICAP Test System mit Python-Server und ClamAV

## 🔧 Verbesserungen

- Dokumentation und Code-Qualität verbessert
...
- [GitHub Release](https://github.com/roimme65/icap-test-script/releases/tag/v1.0.1)
